...
# lines on the dark theme, band by band. Also that the map asks for no tile outside the circle. Every fault here is silent. A mask that draws nothing looks like a map. A circle rebaked
